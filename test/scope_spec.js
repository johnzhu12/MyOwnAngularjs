...
describe("Scope", function () {
    ...
    describe("digest", function () {
        ...
        it("correctly handles NaNs", function () {
            ...
            scope.counter = 0;
            scope.$watch(
                function (scope) { return scope.number; }, function (newValue, oldValue, scope) {
                    scope.counter++;
                }
            );
            scope.$digest();
        ...
        it("never executes $applyAsync ed function in the same cycle", function (done) {
            ...
            scope.$digest(); expect(scope.asyncApplied).toBe(false); setTimeout(function () {
        ...
        it("catches exceptions in $applyAsync", function (done) {
            ...
            setTimeout(function () {
                expect(scope.applied).toBe(true); done();
            }, 50);
        });
        ...
        it("allows destroying a $watch during digest", function () {
            ...
            scope.$digest();
            // expect(watchCalls).toEqual(['first', 'second', 'third', 'first', 'second', 'third']);
            // console.log(watchCalls)//['first', 'second', 'first', 'third', 'first', 'third']
        ...
        it("allows destroying several $watches during digest", function () {
            ...
            var destroyWatch2 = scope.$watch(function (scope) { return scope.aValue; },
                function (newValue, oldValue, scope) {
                    scope.counter++;
                }
            );
...
describe("inheritance", function () {
    ...
    it("inherits the parent's properties", function () {
        ...
        parent.aValue = [1, 2, 3];
        var child = parent.$new(); expect(child.aValue).toEqual([1, 2, 3]);
    });
    ...
    it("does not cause a parent to inherit its properties", function () {
        var parent = new Scope();
        var child = parent.$new(); child.aValue = [1, 2, 3];
