...
describe("Scope", function () {
    ...
    describe("digest", function () {
        ...
        //             console.log('我就想看我调了lisn1几次,newValue', newValue);
        //             console.log('我就想看我调了lisn1几次,oldValue', oldValue);
        //             if (newValue) {
        ...
        //         function (newValue, oldValue, scope) {
        //             console.log('我就想看我调了lisn2几次,newValue', newValue);
        //             console.log('我就想看我调了lisn2几次,oldValue', oldValue);
        //             if (newValue) {
